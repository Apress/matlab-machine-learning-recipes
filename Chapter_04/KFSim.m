%% KFSIM  Demonstrate a Kalman Filter for an oscillator.
% The oscillator is a single degree of freedom (2 state) system with a spring
% and a damper. The measurement is of the position. Simulation is using 4th
% order Runge-Kutta integration. The oscillator has a step input.
%
%% See also
% RHSOscillator, CToDZOH, KFInitialize, KFUpdate, RungeKutta, KFPredict,
% TimeLabel, PlotSet
