%% Oscillator Demo
% Demonstrate an oscillator. This is a linear spring and damper. The measurement
% is the angle between the mass and the horizon as taken from the selected
% baseline.
%% See also
...
yTheta1Sigma  = atan(yR1Sigma/baseline);   % 1 sigma angle measurement noise
