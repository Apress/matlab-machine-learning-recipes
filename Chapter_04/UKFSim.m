%% UKFSIM Demonstrate an Unscented Kalman Filter.
% The model is an oscillator. The measurement is the angle between the line of
% sight from a sensor and the horizon. This measurement is nonlinear. The UKF
% can handle nonlinear measurements directly. The dynamical model is linear.
%
%% See also
% RHSOscillator, KFInitialize, AngleMeasurement, UKFWeight, UKFUpdate,
% UKFPredict, RungeKutta, KFSim, TimeLabel, PlotSet
