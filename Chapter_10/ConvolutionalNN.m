%% ConvolutionalNN Implements a convolutional neural net with pooling.
%% Form
...
function x = DToX( d )
%%% Convert data structure to x array
...
% r is the probability that t{k} is recognized. It should be 1
y = 1 - mean(r);

function r = Testing( d, t )
%%% ConvolutionalNN>Testing
r = NeuralNet( d, t );
...
%%% ConvolutionalNN>DefaultDataStructure
