%% UKF automobile demo for a car with passing and lane change.
...
%   
%% See also: 
% AutomobileInitialize, AutoRadar, AutomobilePassing, AutomobileLaneChange,
% RHSAutomobile, RHSAutomobileXY, AutoRadarUKF, UKFWeight, UKFPredict,
% UKFUpdate, MHTDistanceUKF
...
ukf = KFInitialize( 'ukf','f',@RHSAutomobileXY,'alpha',1,...
                    ...
                    'p',diag(p0),'q',diag(q0),'hData',struct('theta',0),...
